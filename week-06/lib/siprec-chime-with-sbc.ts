...
export class SIPRECChimeWithSBC extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const voiceConnectorStreamingResource = new CustomResource(this, 'voiceConnectorStreamingResource', { 
      serviceToken: voiceConnectorProvider.serviceToken,
      properties: { 'region': this.region,
                    'eip': sbcEip.ref,
                    'streaming': true}
    ...
    const streamingHostName = voiceConnectorStreamingResource.getAttString('outboundHostName')

    const streamingHostNameParameter = new ssm.StringParameter(this, 'streamingHostNameParameter', {
      parameterName: '/asterisk/streamingHostName',
      stringValue: streamingHostName
    })
    ...
    streamingHostNameParameter.grantRead(asteriskRole)
    ...
    new cdk.CfnOutput(this, 'streamingHostName', { value: streamingHostName})
  }
}
