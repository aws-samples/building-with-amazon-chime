...
def createVoiceConnector (region, phoneNumber, cdr_bucket):
...
def on_create(event):
  ...
  cdr_bucket = event['ResourceProperties']['cdr_bucket']

  newPhoneNumber = getPhoneNumber()
  voiceConnector = createVoiceConnector(region, newPhoneNumber, cdr_bucket)
